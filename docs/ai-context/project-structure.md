...
本文档提供了一个模板,用于记录你项目的完整技术栈和文件树结构。**AI 代理在尝试任何任务之前必须阅读此文件,以了解项目组织。**
...
- **[Web 框架] [版本]** - Web 框架及特定功能(异步、类型提示等)
- **[服务器] [版本]** - 应用服务器配置
- **[配置] [版本]** - 配置管理方法
...
- FastAPI 0.115.0+ - 带有类型提示和异步支持的 Web 框架
...
*此模板为记录项目结构提供了全面的基础。根据你的具体技术栈、架构决策和组织要求进行调整。*
